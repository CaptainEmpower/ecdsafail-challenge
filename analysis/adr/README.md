...
| [0028](0028-reusable-proof-toolkit.md) | Package the verification methodology as a reusable proof toolkit (design-only, issue #70) | Proposed (do NOT carve primitives out of the scored circuit — byte-identical risk, score-specialized, single consumer; the reusable asset is the *methodology* — z3 sim-semantics replayer + emitted-op drift guard + reference/Kani bridges; primitive crate deferred to a clean-room build) |
